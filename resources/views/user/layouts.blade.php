...
<body class="bg-slate-100">
    <header id="navbar"
        ...
        <nav class="flex justify-between items-center w-[92%] mx-auto py-4">
            ...
            <div class="flex items-center gap-8 nav-links hidden md:flex">
                <ul class="flex md:flex-row flex-col md:items-center md:gap-[4vw] gap-8 text-slate-800">
                    <li><a class="font-semibold hover:text-slate-500" href="#beranda">Beranda</a></li>
                    <li><a class="font-semibold hover:text-slate-500" href="#tentang">Tentang</a></li>
                    <li><a class="font-semibold hover:text-slate-500" href="#layanan">Layanan</a></li>
                    <li><a class="font-semibold hover:text-slate-500" href="#kontak">Kontak</a></li>
                    <li><a class="font-semibold text-white bg-blue-500 px-4 py-2 rounded-full hover:bg-blue-600 transition-all duration-300 transform hover:scale-105"
                            href="{{ route('digilib') }}">DigiLib</a></li>
                </ul>
            </div>
    ...
    <script>
        ...
        window.addEventListener('scroll', () => {
            ...
            // Panggil highlightMenuOnScroll saat scroll
